...
// Prepare and execute SQL statement to get user's username
...
<header>
    <div class="topBar">
        ...
        <div class="sign-log">
            <div class="header">
                <span id="usename">Welcome, <?php echo $userName; ?></span>
                ...
                <div class="slideshow-container">
                    ...
                    <div class="intro-page">
                        ...
                        <div class="button-container text-left" style="padding-bottom: 15px;">
                            <a class="btn btn-lg btn-primary d-inline-block" href="slideshow_login.php" role="button" style="background-color: #0ce7eb; width: 40%; opacity: 0.8;">Book Here..</a>
                        </div>
